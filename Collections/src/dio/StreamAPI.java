...
public class StreamAPI {
    ...
    public static void main(String[] args) {
        ...
        //Simplificando o trecho 41 a 46
        ...
        //Simplificando agora o trecho 49 a 55
        Set<Map.Entry<Integer, Contato>> set = new TreeSet<>(Comparator.comparing(
                cont -> cont.getValue().getNumero()));  //Construímos o lambda a partir do código acima.
        ...
        for (
                Map.Entry<Integer, Contato> entry : set1) {
            System.out.println(entry.getKey() + " - " + entry.getValue().getNome());
        }
    }
}

//A classe Contato está criada no arquivo "ExercProposto.java" no mesmo pacote.
/*class Contato {
    private String nome;
