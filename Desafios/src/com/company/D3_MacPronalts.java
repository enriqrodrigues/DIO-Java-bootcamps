...
public class D3_MacPronalts {
    public static void main(String[] args) {
        ...
        int N = Integer.parseInt(sc.nextLine());    //Entrada: qtd de produtos diferentes.

        for (int x=0 ; x<N ; x++){
            produtos = sc.nextInt();                //Entrada: código do produto.
            quantidade  = sc.nextInt();             //Entrada: qtd de produtos.
